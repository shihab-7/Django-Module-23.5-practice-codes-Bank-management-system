...
# auto mail generator for different purposes
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            if valid_receiver is not None:
                ...
                # email to sender
                send_transaction_email(self.request.user, send_amount,'Transfer Message', 'transactions/transfer_email.html')
                ...
                # email to receiver
                send_transaction_email(valid_receiver.user, send_amount,'Receive Message', 'transactions/receiver_email.html')
